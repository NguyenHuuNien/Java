...
public class pnTTGiangVien extends javax.swing.JPanel {
    private JPanel prevCallThisPanel;
    private KhoaHoc khoaHoc;
    private GiangVien gv;
    
    public pnTTGiangVien(GiangVien gv, KhoaHoc khoaHoc, JPanel prevPanel) {
        initComponents();
        this.khoaHoc = khoaHoc;
        this.gv = gv;
        this.prevCallThisPanel = prevPanel;
        txtError.setText("");
        setData();
    }
    private void setData(){
        ...
        if(gv.getGioiTinh()!=null){
            rdNam.setSelected(gv.getGioiTinh().length()>2?true:false);
    ...
    private void initComponents() {
        ...
        pnCenter.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin giảng viên", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Segoe UI Black", 2, 18), new java.awt.Color(51, 51, 255))); // NOI18N
