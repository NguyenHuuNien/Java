...
public class pnTTHocVien extends javax.swing.JPanel {
    ...
    public pnTTHocVien(HocVien hvx, KhoaHoc x) {
        initComponents();
        txtError.setText("");
        this.a = hvx;
        this.khoaHoc = x;
    ...
    private void setData(){
        ...
        rdNam.setSelected(a.getGioiTinh().length()==3?true:false);
        rdNu.setSelected(a.getGioiTinh().length()==2?true:false);
    ...
    private void initComponents() {
        ...
        pnCenter.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông tin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Segoe UI Black", 2, 18), new java.awt.Color(51, 51, 255))); // NOI18N
        pnCenter.setPreferredSize(new java.awt.Dimension(680, 400));
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(670, 40));
        ...
        txtAge.setPreferredSize(new java.awt.Dimension(200, 25));
        jPanel3.add(txtAge);

        pnCenter.add(jPanel3);

        jPanel4.setPreferredSize(new java.awt.Dimension(670, 40));
        ...
        jPanel8.setPreferredSize(new java.awt.Dimension(200, 25));

        buttonGroup1.add(rdNam);
        rdNam.setText("Nam");
        rdNam.setPreferredSize(new java.awt.Dimension(80, 25));
        ...
        rdNu.setText("Nữ");
        rdNu.setPreferredSize(new java.awt.Dimension(80, 25));
        jPanel8.add(rdNu);
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(670, 40));
        ...
        txtNumberPhone.setPreferredSize(new java.awt.Dimension(200, 25));
        jPanel5.add(txtNumberPhone);

        pnCenter.add(jPanel5);

        jPanel6.setPreferredSize(new java.awt.Dimension(670, 40));
        ...
        cbAddress.setPreferredSize(new java.awt.Dimension(200, 25));
        jPanel6.add(cbAddress);

        pnCenter.add(jPanel6);

        jPanel7.setPreferredSize(new java.awt.Dimension(670, 40));
